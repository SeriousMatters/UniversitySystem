...
public class UniversitySystem {
    ...
    public void showAllStudents() {
        ...
        //                 System.out.println("Subject ID: " + subject.getId() + " -- Mark = " + subject.getMark() + " -- Grade = " + subject.getGrade());
        //             }
        //         }
        //     }
        // }
    ...
    // private void studentMenuAfterLogin() {
    //     System.out.println("Debug: Inside studentMenuAfterLogin, loggedInStudentEmail = " + loggedInStudentEmail);
    ...
    private void enrollSubjects() {
        ...
        if (student.getEnrolledSubjects().size() >= 4) {
            System.out.println("You are now enrolled in 4 out of 4 subjects. Students are allowed to enroll in 4 subjects only.");
            return;
        }
        ...
        System.out.println("You are now enrolled in " + (enrolledCount + subjectsToEnroll) + " out of " + maxEnrollment + " subjects.");
    ...
    //     System.out.println("You are now enrolled in " + autoGeneratedSubjects.size() + " subjects.");
    // }
